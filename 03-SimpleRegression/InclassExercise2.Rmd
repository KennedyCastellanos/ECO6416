...
=======
>>>>>>> 2396e99ef388514b91bfd1e9b78d78d206bbf634
```
...
<<<<<<< HEAD
plot(Wealth1percent$'Time Counter',Wealth1percent$Share, type = "Wealth1percent")
abline(lm(Share ~ 'Time Counter', data = wealth1percent), lty = 2, col="red")
=======
...
```{r wealth regression}
<<<<<<< HEAD
wealthRegression <- lm(Share ~ Time Counter, data=Wealth1percent)
...
```{r}
<<<<<<< HEAD
newPrediction ,_ data.frame(TimeCounter = 133)

predict(wealthRegression, newdata = newPrediction)
=======
newForecast <- data.frame(TimeCounter = max(Wealth1percent$TimeCounter) + 2)
...
```{r}
<<<<<<< HEAD
Covid <- read_excel("Home/Documents/GitHub/ECO6416/Data/Covid.xlsx",
                    col_types = c("date", "numeric", "numeric"))
=======
